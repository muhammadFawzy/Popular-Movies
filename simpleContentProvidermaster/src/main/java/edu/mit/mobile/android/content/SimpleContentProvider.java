...
public abstract class SimpleContentProvider extends ContentProvider {
     ...
     *
     * @param authority the full authority string for this provider
     * @param dbVersion the version of the database schema associated with this provider.
    ...
    /**
     * @param authority the full authority string for this provider
     * @param dbName    the name of the database. This must be unique throughout your {@link Application}.
     * @param dbVersion the version of the database schema associated with this provider.
     *                  <strong>NOTE:</strong> This number must be increased each time the database schema
     *                  (in this instance, your {@link ContentItem} fields) changes in order for the
     *                  tables to be recreated. At the moment, there <strong>WILL BE DATA LOSS</strong>
     ...
     *
     * @param dbHelper the helper you wish to have registered with this provider
     */
     ...
     * any subclasses.
     *
     * @param dbHelper the DBHelper to associate with the given path.
     * @param path     a complete path on top of the content provider's authority.
     * @param type     the complete MIME type for the item's directory.
     * @param verb     one or more of {@link DBHelperMapper#VERB_ALL}, {@link DBHelperMapper#VERB_INSERT}
     ...
     *
     * @param dbHelper
     * @param path     the path that will be used for the item's dir. For the item, it will be suffixed
     *                 with {@value #PATH_ITEM_ID_SUFFIX}.
     * @param dirType  The complete MIME type for the item's directory.
     * @param itemType The complete MIME type for the item.
     */
     ...
     *
     * @param helper     the helper that will handle this request. Usually, this is an {@link M2MDBHelper}.
     * @param parentPath the path of the parent. This should not end in an "#" as it will be added for you
     * @param childPath  the path of the child within an item of the parent.
     */
     ...
     *
     * @param dbHelper the DBHelper to associate with the given path.
     * @param path     a complete path on top of the content provider's authority. <strong>This must end
     *                 in <code>{@value #PATH_ITEM_ID_SUFFIX}</code></strong>
     * @param type     The complete MIME type for this item.
     * @param verb     one or more of {@link DBHelperMapper#VERB_ALL}, {@link DBHelperMapper#VERB_INSERT}
     *                 , {@link DBHelperMapper#VERB_QUERY}, {@link DBHelperMapper#VERB_UPDATE},
     *                 {@link DBHelperMapper#VERB_DELETE} joined bitwise.
     */
     ...
     *
     * @param searchHelper
     * @param path         the path, without any starting or ending slashes. This will be suffixed with
     ...
     *
     * @param path the path to suffix the whole query. can be null, which will simply output
     *             {@link SearchManager#SUGGEST_URI_PATH_QUERY}.
     ...
     *
     * @param type      MIME type for the given {@link ContentItem}
     ...
     *
     * @param type the {@link ContentItem}'s MIME type
     ...
     *
     * @param uri a URI which has MIME types registered with this provider
     * @return the class of the {@link ContentItem} or null if there's no mapping
     */
